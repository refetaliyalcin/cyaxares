function [ref_nh,tra_nh,absorptance] = rte_polydisperse(calculate_boundary_reflection,dependent_scattering,effective_medium,exact_scattering_phase,lambda,thickness,radius,f_v,polar_angle_deg,n_medium,k_medium,n_pigment,k_pigment,n_substrat,k_substrat,photon_number, nang,avg_radius,sigma,no_of_r)
