function [r_tot,t_tot,a_tot]=monte_carlo(photon_number,s_ref,cos_gecen,h,scat_prob,mu_tot,n_medium,k_medium,n_subs,k_subs,inv_cdf_cos,g,exact_scattering_phase)
r_tot=0;
t_tot=0;
a_tot=0;
n_cdf_random=length(inv_cdf_cos);
